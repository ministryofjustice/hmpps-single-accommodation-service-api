...
class EligibilityService(
  ...
  private val cas1DataRuleSet: Cas1DataRuleSet,
  ...
  private val cas1DataContextUpdater: Cas1DataContextUpdater,
  ...
  fun calculateEligibilityForCas1(data: DomainData): ServiceResult {
    ...
    val tree =
      treeBuilder
        .ruleSet("Cas1Data", cas1DataRuleSet, cas1DataContextUpdater)
        .onPass(completion)
