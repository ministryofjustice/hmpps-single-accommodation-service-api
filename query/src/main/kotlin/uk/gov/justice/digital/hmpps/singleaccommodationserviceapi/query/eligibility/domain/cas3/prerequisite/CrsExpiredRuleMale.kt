...
@Component
class CrsExpiredRuleMale(val clock: Clock) : Rule {
  override val description = "FAIL if CRS not within 12 weeks and male"
  override fun evaluate(data: DomainData): RuleResult {
    ...
    return RuleResult(
      ...
      failureReason = if (isFail) FailureReason.CRS_EXPIRED_MALE else null,
    )
  }
}
