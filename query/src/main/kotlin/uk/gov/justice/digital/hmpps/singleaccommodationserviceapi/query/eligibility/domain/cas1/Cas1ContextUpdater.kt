...
import uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.eligibility.domain.cas1.Cas1ServiceResultTransformer.toServiceResult
...
class Cas1ContextUpdater(val clock: Clock) : ContextUpdater {
  ...
  override fun update(context: EvaluationContext): EvaluationContext {
    val updatedServiceResult = toServiceResult(context.data, clock)
