package uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.domain.validation
...
class ValidationContextUpdaterTest {
  private val updater = ValidationContextUpdater()
