...
class AccommodationReferralTransformerTest {
  ...
  fun `all ApprovedPremisesApplicationStatus values map correctly`() {
    val expectedMapping = mapOf(
      ...
      ApprovedPremisesApplicationStatus.WITHDRAWN to AccommodationReferralStatus.WITHDRAWN,
      ApprovedPremisesApplicationStatus.EXPIRED to AccommodationReferralStatus.EXPIRED,
      ...
      ApprovedPremisesApplicationStatus.UNALLOCATED_ASSESSMENT to AccommodationReferralStatus.PENDING,
