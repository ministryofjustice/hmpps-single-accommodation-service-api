...
class MaleRiskRuleTest {
  ...
  @ParameterizedTest
  @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.domain.cas1.rules.eligibility.MaleRiskRuleTest#provideSexAndTierToPass")
  ...
  @ParameterizedTest
  @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.domain.cas1.rules.eligibility.MaleRiskRuleTest#provideSexAndTierToFail")
