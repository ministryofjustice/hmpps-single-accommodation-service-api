...
class Cas1ApplicationTest {
  ...
  inner class TransformToServiceStatus {
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.Cas1ApplicationTest#providePlacementStatusInputsAndServiceStatusOutputs")
    fun `cas 1 application present with status PLACEMENT_ALLOCATED so result contains appropriate placement status`(
      ...
      val result = with(eligibilityService) {
        cas1Application.toServiceStatus()
      }
      assertThat(result).isEqualTo(serviceStatus)
    }

    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.Cas1ApplicationTest#provideApplicationStatusInputsAndServiceStatusOutputs")
  ...
  inner class BuildActions {
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.Cas1ApplicationTest#provideStatusInputsAndOutputActions")
