...
class Cas1ApplicationStatusTest {
  ...
  inner class ToServiceStatus {
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.query.unit.eligibility.Cas1ApplicationStatusTest#provideStatusInputsAndOutputs")
