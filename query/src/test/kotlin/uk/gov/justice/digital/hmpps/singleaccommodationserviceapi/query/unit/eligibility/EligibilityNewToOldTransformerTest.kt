    ...
    val eligibilityDtoOld = EligibilityDto(
      ...
      cas1 = Cas1ServiceResult(
        serviceResult = ServiceResult(
          ...
          action = CaseAction(
            type = cas1ServiceResult.serviceResult.serviceStatus.action!!,
      ...
      cas2 = Cas2ServiceResult(
        serviceResult = ServiceResult(
          serviceStatus = ServiceStatus.UPCOMING,
          action = CaseAction(
            type = cas2ServiceResult.serviceResult.serviceStatus.action!!,
      ...
      cas3 = Cas3ServiceResult(
        serviceResult = ServiceResult(
          ...
          action = CaseAction(
            type = cas3ServiceResult.serviceResult.serviceStatus.action!!,
      ...
      dtr = DtrServiceResult(
        serviceResult = ServiceResult(
          serviceStatus = ServiceStatus.UPCOMING,
          action = CaseAction(
            type = dtrServiceResult.serviceResult.serviceStatus.action!!,
      ...
      crs = CrsServiceResult(
        serviceResult = ServiceResult(
          serviceStatus = ServiceStatus.UPCOMING,
          action = CaseAction(
            type = crsServiceResult.serviceResult.serviceStatus.action!!,
      ...
      pa = PaServiceResult(
        serviceResult = ServiceResult(
          serviceStatus = ServiceStatus.NOT_STARTED,
          action = CaseAction(
            type = paServiceResult.serviceResult.serviceStatus.action!!,
