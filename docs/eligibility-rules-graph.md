...
- `Cas2ApplicationAwaitingArrivalRule`: FAIL if application is awaiting arrival
...
| Cas2ApplicationAwaitingArrivalRule | FAIL if application is awaiting arrival | Cas2Completion | CAS2 |
