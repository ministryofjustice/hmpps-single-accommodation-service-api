...
@Entity
@Table(name = "out_of_region_referral")
open class OutOfRegionReferralEntity(
  @Id
  val id: UUID,
  val caseId: UUID,
  ...
  @DiffIgnore
  @OneToMany(
    mappedBy = "outOfRegionReferral",
    fetch = FetchType.LAZY,
    cascade = [CascadeType.ALL],
    orphanRemoval = true,
  )
  var notes: MutableList<OutOfRegionReferralNoteEntity> = mutableListOf(),
