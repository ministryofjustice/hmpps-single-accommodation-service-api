...
fun proposedAddressesRequestBody(): String = """
  {
...
fun expectedProposedAddressesResponseBody(id: UUID, createdAt: Instant): String = """
  {
    "id" : "$id",
    "crn" : "X371199",
    "name" : "Mother's caravan",
...
fun expectedProposedAccommodationCreatedDomainEventJson(proposedAccommodationId: UUID) = """
  {
    "aggregateId" : "$proposedAccommodationId",
    "type" : "PROPOSED_ACCOMMODATION_CREATED"
  }
""".trimIndent()
