...
class PersonTest {
  ...
  fun `should format name correctly`(
    ...
    val cpr = Person(firstName = firstname, middleNames = middleNames, lastName = lastName, prisonNumbers = emptyList())

    Assertions.assertThat(cpr.fullName).isEqualTo(expected)
  }
}
