...
fun buildCas1ReferralHistory(
  ...
  status: Cas1AssessmentStatus = Cas1AssessmentStatus.inProgress,
  createdAt: Instant,
) = listOf(
  Cas1ReferralHistory(
...
fun buildCas3ReferralHistory(
  id: UUID = UUID.randomUUID(),
  status: TemporaryAccommodationAssessmentStatus = TemporaryAccommodationAssessmentStatus.inReview,
  createdAt: Instant,
) = listOf(
  Cas3ReferralHistory(
    type = ServiceType.CAS1,
