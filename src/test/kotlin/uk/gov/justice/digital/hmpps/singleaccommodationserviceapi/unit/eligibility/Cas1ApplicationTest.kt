...
class Cas1ApplicationTest {
  ...
  inner class TransformToServiceStatus {
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.unit.eligibility.Cas1ApplicationTest#providePlacementStatusInputsAndServiceStatusOutputs")
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.unit.eligibility.Cas1ApplicationTest#provideApplicationStatusInputsAndServiceStatusOutputs")
  ...
  inner class BuildActions {
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.unit.eligibility.Cas1ApplicationTest#provideStatusInputsAndOutputActions")
