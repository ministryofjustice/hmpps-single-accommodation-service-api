...
@TestData
fun expectedMultiCrnCprServerError() = """{ "data": [${caseJson(name = null, dateOfBirth = null, prisonNumber = null, pncReference = null)}, ${caseJson(name = "Zack Middle Smith", crn = "FAKECRN2", riskLevel = "MEDIUM")}], "upstreamFailures": [${cprServerErrorFailure(identifierCrn = "FAKECRN1")}] }"""

@TestData
fun expectedMultiCrnCprTimeout() = """{ "data": [${caseJson(name = null, dateOfBirth = null, prisonNumber = null, pncReference = null)}, ${caseJson(name = "Zack Middle Smith", crn = "FAKECRN2", riskLevel = "MEDIUM")}], "upstreamFailures": [${cprTimeoutFailure("FAKECRN1", identifierCrn = "FAKECRN1")}] }"""

@TestData
fun expectedMultiCrnRoshServerError() = """{ "data": [${caseJson(riskLevel = null)}, ${caseJson(name = "Zack Middle Smith", crn = "FAKECRN2", riskLevel = "MEDIUM")}], "upstreamFailures": [${roshServerErrorFailure(identifierCrn = "FAKECRN1")}] }"""

@TestData
fun expectedMultiCrnRoshTimeout() = """{ "data": [${caseJson(riskLevel = null)}, ${caseJson(name = "Zack Middle Smith", crn = "FAKECRN2", riskLevel = "MEDIUM")}], "upstreamFailures": [${roshTimeoutFailure("FAKECRN1", identifierCrn = "FAKECRN1")}] }"""

@TestData
fun expectedMultiCrnTierServerError() = """{ "data": [${caseJson(tierScore = null, tier = null)}, ${caseJson(name = "Zack Middle Smith", crn = "FAKECRN2", riskLevel = "MEDIUM")}], "upstreamFailures": [${tierServerErrorFailure(identifierCrn = "FAKECRN1")}] }"""

@TestData
fun expectedMultiCrnTierNotFound() = """{ "data": [${caseJson(tierScore = null, tier = null)}, ${caseJson(name = "Zack Middle Smith", crn = "FAKECRN2", riskLevel = "MEDIUM")}], "upstreamFailures": [${tierNotFoundFailure(identifierCrn = "FAKECRN1")}] }"""

@TestData
fun expectedMultiCrnAllUpstreamFailures() = """{ "data": [${caseJson(name = null, dateOfBirth = null, prisonNumber = null, pncReference = null, tierScore = null, tier = null, riskLevel = null)}, ${caseJson(name = null, dateOfBirth = null, crn = "FAKECRN2", prisonNumber = null, pncReference = null, tierScore = null, tier = null, riskLevel = null)}], "upstreamFailures": [${cprServerErrorFailure(identifierCrn = "FAKECRN1")}, ${roshServerErrorFailure(identifierCrn = "FAKECRN1")}, ${tierServerErrorFailure(identifierCrn = "FAKECRN1")}, ${cprServerErrorFailure(identifierCrn = "FAKECRN2")}, ${roshServerErrorFailure(identifierCrn = "FAKECRN2")}, ${tierServerErrorFailure(identifierCrn = "FAKECRN2")}] }"""
