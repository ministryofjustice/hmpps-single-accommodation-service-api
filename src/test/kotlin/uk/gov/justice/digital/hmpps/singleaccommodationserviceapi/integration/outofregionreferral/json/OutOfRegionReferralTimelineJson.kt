package uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.integration.outofregionreferral.json

import java.util.UUID

fun expectedGetOutOfRegionReferralTimelineResponse(
  outOfRegionReferralId: UUID,
  caseId: UUID,
