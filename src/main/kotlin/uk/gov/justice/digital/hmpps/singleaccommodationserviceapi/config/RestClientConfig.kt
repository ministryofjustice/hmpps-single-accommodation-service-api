...
import uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.aggregator.config.HmppsAuthInterceptor
import uk.gov.justice.digital.hmpps.singleaccommodationserviceapi.aggregator.security.retry.RetryInterceptor
...
class RestClientConfig(
  ...
  @Bean
  fun probationIntegrationDeliusClient(@Value($$"${service.probation-integration-delius.base-url}") baseUrl: String) =
    createClient(
      baseUrl,
  ...
  @Bean
  fun probationIntegrationOasysClient(@Value($$"${service.probation-integration-oasys.base-url}") baseUrl: String) =
    createClient(
      baseUrl,
